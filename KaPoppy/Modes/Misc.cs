...
namespace Modes
{
    ...
    class Misc : Helper
    {
        public static void Execute()
        {
            ...
            if (Menu.UseQ && QDMG > target.Health && Lib.Q.IsReady() && target.IsValidTarget(Lib.Q.Range) && Lib.Q.GetPrediction(target).HitChance >= EloBuddy.SDK.Enumerations.HitChance.High)
            {
